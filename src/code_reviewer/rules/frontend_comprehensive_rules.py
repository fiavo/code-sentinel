"""
Comprehensive frontend patterns for all frameworks and libraries.
"""
import re
...
class FrontendComprehensiveRules(BaseRule):
    @property
    def name(self) -> str:
        return "frontend_comprehensive"
    @property
    def description(self) -> str:
        return "Comprehensive frontend patterns"
    @property
    ...
    def check(self, file_path: str, content: str) -> list[CodeIssue]:
        ...
        patterns = [
            ...
            (r"MobX|makeObservable|makeAutoObservable|observable|computed|action|runInAction|reaction|autorun|when|configure|enforceActions", "MobX", "Good: using MobX", Severity.INFO),
            ...
            # i18n
            (r"i18next|react-i18next|useTranslation|Trans|useI18next|changeLanguage|addResourceBundle", "i18n", "Good: using i18n", Severity.INFO),
            (r"vue-i18n|useI18n|createI18n|TranslateModule|TranslateService", "Vue i18n", "Good: using Vue i18n", Severity.INFO),
            # Accessibility
            ...
            # Validation
            (r"zod|z\.string|z\.number|z\.boolean|z\.array|z\.object|z\.union|z\.enum|z\.literal|z\.nullable|z\.optional|z\.default|z\.transform|z\.refine|z\.superRefine|z\.pipe", "Zod", "Good: using Zod for validation", Severity.INFO),
